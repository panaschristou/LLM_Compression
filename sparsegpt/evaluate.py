...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default='', help="LlaMA model to load")
    parser.add_argument("--tokenizer", type=str, default='huggyllama/llama-13b',help="LlaMA tokenizer to load")
    parser.add_argument(
...
#         args.dataset, nsamples=args.nsamples, seed=args.seed, model=args.tokenizer, seqlen=model.seqlen
#     )
...
#         print(time.time() - tick)
    ...
    for dataset in ["wikitext2", "ptb", "c4"]:
        dataloader, testloader = get_loaders(
            dataset, seed=args.seed, model=args.tokenizer, seqlen=model.seqlen
        )
